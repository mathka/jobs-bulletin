...
class DisjunctionRequirementsSpec extends ObjectBehavior
{
    private const ABILITIES = ['some abilities'];

    public function it_returns_true_when_any_requirements_are_met(
    ...
    public function it_returns_false_when_all_requirements_are_not_met(
        Requirements $firstRequirement,
        Requirements $secondRequirement,
        Requirements $thirdRequirement
    ) {
        ...
        $firstRequirement->areMet(self::ABILITIES)->willReturn(false);
        $secondRequirement->areMet(self::ABILITIES)->willReturn(false);
        $thirdRequirement->areMet(self::ABILITIES)->willReturn(false);
